...
<!--*Time: May 2015-->
<!--*-->
<!--*Student site get time sort by language-->
<!--*-->
<!--*/-->
<?php
session_start();
...
//echo count($mon);print_r($mon);echo "<br>";
//echo count($tue);print_r($tue);echo "<br>";
//echo count($wed);print_r($wed);echo "<br>";
//echo count($thu);print_r($thu);echo "<br>";
//echo count($fri);print_r($fri);echo "<br>";
?>
<table>

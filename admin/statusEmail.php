...
if($tutorStatus == Enabled)
{
    $message = "<html>
            <head>
            <title>Your tutoring status is changed</title>
            </head>
            <body>
            <?php
            <p> Hi $name</p><br/>
            <p> Your tutor status has been set to 'Available'.<br/>
                Welcome back!</p>
...
if($tutorStatus == Disabled)
{
    $message = "<html>
            ...
            <?php
            <p> Hi $name</p><br/>
            <p> Your tutor status has been set to 'Unavailable'.<br/>
                Please contact the administrator if this is an unexpected occurrence.</p>

...
<!--*Time: May 2015-->
<!--*-->
<!--*This page is for admin get avaliable time for particular tutor-->
<!--*-->
<!--*/-->
<?php
session_start();
...
<!---->
<?php
//foreach($Time as $lang){
//
//    $result=mysql_query("SELECT * FROM tutors WHERE tutor_Id = '$lang'");
//    $row = mysql_fetch_array($result);
//    $tutname[]=$row['FirstName']." ".$row['LastName'];
//}
//
//?>

...
$message = "<html>
            <head>
            <title>You have been hired by CS learning centre</title>
            </head>
            <body>
            <?php
            <p> Hi $name</p><br/>
            <p> You have been hired by CS learning centre </p>

            <p> Many thanks for your interest in becoming a Computer Science tutor.<br/>
             Please arrange an appointment with Dr Cheryl Pope to get the details sorted out so you can start straight away!<br/>

<?php
/*
we use this file to connect to our database. all credit to the author of the script
...
*/
 ...
 $ACCESS_PWD='YourPassword'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"YourUserName",#required
 'pwd'=>"YourPassword", #required
 'db'=>"YourDatabaseName",  #optional, default DB
 'host'=>"",#optional
 'port'=>"",#optional
